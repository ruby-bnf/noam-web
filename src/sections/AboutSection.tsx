      ...
      <div className="mx-auto grid min-h-[calc(100vh-7.5rem)] w-full max-w-6xl grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-10">
        <div className="order-1 flex flex-col justify-center lg:order-1">
          <div className="max-w-xl space-y-6">
            ...
            <h2 className="section-title text-[clamp(2rem,3.6vw,3.8rem)] leading-[0.98] tracking-[0.05em] uppercase text-[rgba(var(--colors-Primary-dark-green-rgb),1)]">
              <span className="block"> {aboutSectionContent.title}</span>
            </h2>

            <p className="m-0 text-[clamp(1rem,1.2vw,1.12rem)] leading-[1.75] text-[rgba(var(--colors-Primary-dark-green-rgb),0.84)]">
